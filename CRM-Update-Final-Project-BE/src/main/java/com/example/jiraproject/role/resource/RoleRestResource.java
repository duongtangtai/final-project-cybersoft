...
public class RoleRestResource {
    ...
    @Authorized(operation = ApiUtil.ROLE)
    @GetMapping("/{id}")
    ...
    @Authorized(operation = ApiUtil.ROLE, type = Operation.Type.SAVE_OR_UPDATE)
    @PostMapping
    ...
    @Authorized(operation = ApiUtil.ROLE, type = Operation.Type.REMOVE)
    @DeleteMapping("/{id}")
