...
public class FileRestResource {
    ...
    @GetMapping("/{username}")
    public ResponseEntity<Resource> findFindByUsername(@PathVariable("username") String username) {
        return ResponseEntity.ok()
                .contentType(MediaType.IMAGE_JPEG)
                .body(service.load(username));
    }
